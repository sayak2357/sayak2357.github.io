...
var chart = new CanvasJS.Chart("chartContainer7", {
	...
	data: [{
		...
		dataPoints: [
			...
			{ y:0.07692307692307693, x: new Date(2001,0) },
			{ y:0.08571428571428572, x: new Date(2002,0) },
			{ y:0.2, x: new Date(2003,0) },
			{ y:0.375, x: new Date(2004,0) },
			{ y:0.6410256410256411, x: new Date(2005,0) },
			{ y:0.23684210526315788, x: new Date(2006,0) },
			{ y:0.8549618320610687, x: new Date(2007,0) },
			{ y:0.875, x: new Date(2008,0) },
			{ y:0.7777777777777778, x: new Date(2009,0) },
			{ y:0.5517241379310345, x: new Date(2010,0) },
			{ y:0.7931034482758621, x: new Date(2011,0) },
			{ y:1.0719424460431655, x: new Date(2012,0) },
			{ y:1.08, x: new Date(2013,0) },
			{ y:1.4, x: new Date(2014,0) },
			{ y:1.4736842105263157, x: new Date(2015,0) },
			{ y:1.6774193548387097, x: new Date(2016,0) },
			{ y:1.488888888888889, x: new Date(2017,0) },
			{ y:1.4642857142857142, x: new Date(2018,0) }
		]
		},
		]
});
